...
// Angstrom is the Angström index. It is a Swedish index. It is simple, and you
// can calculate it in your head. A low value means more danger. This is the
// opposite of the other indices in this package.
...
// Class gives the danger category. The index runs opposite to the danger, so the
// limits decrease. Above 4.0 is low. 2.5 to 4.0 is moderate. 2.0 to 2.5 is high.
// 2.0 or less is very high.
